 ...
 *
 * Bewusst keine Bilddatei: nur inline erbt die Marke die Textfarbe
 * (currentColor) und reagiert damit auf Hover und Fokus. Die vier Marken
 * oben stehen fuer die vier im Kollektiv.
 */
  ...
  return (
    ...
    >
      <g fill="var(--c-accent)">
        ...
        <rect x="37" y="0" width="3" height="3" />
        <rect x="74" y="0" width="3" height="3" />
        <rect x="111" y="0" width="3" height="3" />
      </g>
      <g fill="currentColor">
      <path fillRule="evenodd" d="M15.0 8 L30.0 38.0 L22.75 38.0 L19.875 32.0 L10.125 32.0 L7.25 38.0 L0 38.0 Z M12.625 26.875 L17.375 26.875 L15.0 21.25 Z" />
